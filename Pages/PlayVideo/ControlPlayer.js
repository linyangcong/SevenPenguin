...
// class ControlPlayer extends React.Component {
//     constructor(props) {
//         super(props);
//         this.state = {
//             Videostatus:false,//true全频
//             videoheight:height,
//         }
//     }
//     componentDidMount(){
//         console.log(this.refs.videoplayer._reactInternalFiber.memoizedProps.paused)
//     }
//     render() {
//         return (
//             <ScrollView>
...
//             ref='videoplayer'
//             paused={true}
//                 style={{height:this.state.Videostatus?this.state.videoheight:this.state.videoheight*0.3}}
//                 // videoStyle={this.state.Videostatus?playerstyle.videoStylemax:playerstyle.videoStylemin}
...
//                 onExitFullscreen={()=>
//                     {
//                         this.setState({Videostatus:false,videoheight:height})
...
// //     },
// //     videoStylemin:{
// //         height:this.state.videoheight*0.3
// //     }
// // })
...
export default class VideoPlayer extends Component {
    static defaultProps = {
        ...
        rate:                           1,
        isFullscreen:                   false,
        onEnterFullscreen:              'landscape',  //portrait
    };
    ...
    */
    ...
    _toggleFullscreen() {
        ...
        if (state.isFullscreen) {
            ...
            Orientation.lockToLandscape() 
            this.props.showDiscussion(state.isFullscreen)
            // state.fullscreenOrientation ='portrait'; //  landscape,portrait
        }
        else {
            typeof this.events.onExitFullscreen === 'function' && this.events.onExitFullscreen();
            Orientation.lockToPortrait()
            this.props.showDiscussion(state.isFullscreen)
            // state.fullscreenOrientation ='landscape'; //  landscape,portrait
        }
            ...
            >
                <View style={[ styles.player.container, this.styles.containerStyle ]}>
                    <Video
                        ...
                        source={{ uri: this.props.navigation.getParam('playuri')} }
                    />
                    { this.renderError() }
